...
class Report
{
    ...
    {
        echo "Ini adalah halaman report index!";
    }
}
...
//                 if ($userRole === 'agen') {
//                     $data['report'] = $this->model('Report_model')->getReportByDateRangeAndUserId($from, $to, $userId);
//                 } else {
//                     $data['report'] = $this->model('Report_model')->getReportByDateRange($from, $to);
//                 }
//             }
//         }
...
//                 if ($user_id) {
//                     $data['report'] = $this->model('Report_model')->getReportByDateRangeAndUserId($from, $to, $user_id);
//                 } else {
//                     $data['report'] = $this->model('Report_model')->getReportByDateRange($from, $to);
//                 }
