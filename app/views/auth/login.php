...
<head>
    ...
    <link rel="shortcut icon" href="<?= BASEURL; ?>/img/JNE.png">
    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
        <div class="card p-4 shadow-lg" style="width: 350px;">
            <div class="text-center">
                <img src="<?= BASEURL; ?>/img/JNE.png"
                    alt="Twitter Logo" width="90">
                <h4 class="mt-3" style="border-bottom: 1px solid black;">APP CANCEL</h4>
                <?php Flasher::loginFlash(); ?>
            </div>
            <form class="mt-3" action="<?= BASEURL; ?>/auth/login" method="post">
                <div class="mb-3">
